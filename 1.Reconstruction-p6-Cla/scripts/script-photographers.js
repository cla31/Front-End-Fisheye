...
//Pour extraire juste l'id en enlevant le point d'interrogation

//????????????????????????????
//N'affiche pas les données comme ça, la promise est en statut "pending"
//Possible d'afficher les données dans une variable?
const resultats = getDatas(pathJsonProject)
